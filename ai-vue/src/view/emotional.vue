<template>
    <div>
        ...
        <el-table :data="tableData" style="width: 100%">
            ...
            <el-table-column label="情绪评分" >
                <template #default="scope">
                    ...
                    <!-- 第一个属性为具体评分需要传入的数据，第二个是最大分数-需要和用户输入的分数范围一致 disabled属性：只显示，不能点击/操作 -->
                </template>
            </el-table-column>
        ...
        <div v-if="currentDetail" class="detail-content">
            ...
            <div class="detail-section">
                ...
                <el-descriptions :column="2" border>
                    ...
                    <el-descriptions-item label="压力水平">{{ currentDetail.diaryDate}}/5</el-descriptions-item>
                </el-descriptions>
            </div>
            <div class="detail-section">
                <h4>日记内容</h4>
                ...
                <div class="ai-analysis-result">
                    <el-descriptions :column="2" border>
                        ...
                        <el-descriptions-item label="情绪强度">
                            ...
                            <!-- 实现类似于进度条的效果  :percentage:传入当前进度  :stroke-width：进度条的宽度 -->
                        </el-descriptions-item>
        ...
        <!-- dialog组件实现弹窗效果  v-model：控制弹窗的显示和隐藏 -->
         <!-- 用element-plus中的描述组件来实现描述列表 -->
    </div>
</template>
...
const viewSessionDetail = (row) =>{
    ...
    if(row.aiEmotionAnalysis){
        ...
        //如果数据存在，通过JSON.parse将其转换为对象类型并赋值给aiData
    }else{
        aiData.value = {}
        //不存在--置空==初值
    }
